                 ...
                 bsCollapsePanel("Functional Class Scoring",
                                 ...
                                 column(width=12,style="padding-left:25px;padding-right:25px;",
                                       ...
                                       #         conditionalPanel(condition = "",
                                                                 tags$div(tags$h5(style='font-weight:bold',"Description:")), tags$p(style='font-weight:normal',"Functional class scoring determines enrichment of functional classes or sets (e.g. pathways, modules, classes) in 
