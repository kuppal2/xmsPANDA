...
<<<<<<< HEAD
      tags$title("xmsPANDA - v1.1.68"),
=======
      tags$title("xmsPANDA - v1.1.67"),
>>>>>>> c3ff66c6826817a36eed061db658de2fb3145900
    ...
    column(12,
        tags$div(id="form",
<<<<<<< HEAD
          h3(tags$img(style="float:left;margin-right:15px;",src="images/xmsPANDA_log.png",height='80px',width="80px"),"xmsPANDA - R package for biomarker discovery, supervised and unsupervised learning, and network analysis (v1.1.68)")),
=======
          h3(tags$img(style="float:left;margin-right:15px;",src="images/xmsPANDA_log.png",height='80px',width="80px"),"xmsPANDA - R package for biomarker discovery, supervised and unsupervised learning, and network analysis (v1.1.67)")),
>>>>>>> c3ff66c6826817a36eed061db658de2fb3145900
        tabsetPanel(
