...
#  shinyjs::extendShinyjs(text = jsResetCode),
    ...
    tags$head(
      ...
      tags$title("xmsPANDA - v1.1.69"),
      tags$link(rel = "stylesheet", type = "text/css", href = "mystyle.css")
    ),
    column(12,
        tags$div(id="form",
          h3(tags$img(style="float:left;margin-right:15px;",src="images/xmsPANDA_log.png",height='80px',width="80px"),"xmsPANDA - R package for biomarker discovery, supervised and unsupervised learning, and network analysis (v1.1.69)")),
        tabsetPanel(
