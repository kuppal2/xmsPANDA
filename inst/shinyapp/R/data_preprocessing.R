    ...
    mainPanel(
      ...
      bsCollapse(open = "Replicate summarization",
                ...
                bsCollapsePanel("Imputation, transformation, and normalization",
                 column(width=12,selectInput(width="350px","summary_na_replacement","Choose an imputation method:",c("halffeaturemin","knn","randomforest","QRILC","zeros","halfsamplemin","halfdatamin","none"))),
                ...
                "EigenMS normalizaiton"="eigenms_norm",
                 ...
                 "Surrogate variable analysis"="sva_norm",
                  ...
                  "cubicspline normalization"="cubicspline_norm"),selected=c("log2transform"))),
