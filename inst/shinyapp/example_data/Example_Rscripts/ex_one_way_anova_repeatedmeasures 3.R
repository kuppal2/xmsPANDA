...
source("/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/xmsPANDA_v1.0.6.44.R")
...
class_labels_file<-"/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/git/xmsPANDA_v1.0.7.2/examples_and_manual/Example_feature_table_and_classlabels/classlabels_one_factor_repeatedmeasures_2timepoints.txt"

outloc<-"~/Downloads/testpandav1.0.7.544onewayrepeat2TPB/"
...
demetabs_res<-diffexp(
        ...
        ##3) arguments for feature seletion:,"lm1wayanovarepeat","limma1wayrepeat","spls1wayrepeat"
        pairedanalysis = TRUE, featselmethod=c("spls1wayrepeat","ttestrepeat","lm1wayanovarepeat","limma1wayrepeat","wilcoxrepeat"),pvalue.thresh=0.05,
        ...
        aggregation.method="Consensus",mars.gcv.thresh=10,
