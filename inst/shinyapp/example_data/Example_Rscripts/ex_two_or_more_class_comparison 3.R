...
parentoutput_dir="/Users/karanuppal/Downloads/examples_and_manual 2/Example_feature_table_and_classlabels/H1N1outknn/"
...
demetabs_res<-diffexp(
        ...
        pairedanalysis = FALSE, featselmethod=c("limma","pls","RF"),
        pvalue.thresh=0.05,
