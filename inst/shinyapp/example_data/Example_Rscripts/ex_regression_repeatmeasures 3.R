...
class_labels_file<-"/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/xmsPANDA_v1.1.57/examples_and_manual/Example_feature_table_and_classlabels/classlabels_regression_repeatmeasures.txt"
parentoutput_dir<-"/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/xmsPANDA_v1.0.7.5/examples_and_manual/Example_feature_table_and_classlabels/regrep/"
...
demetabs_res<-diffexp(
        ...
        #"lm2wayanova","lm2wayanovarepeat","limma2way","limma2wayrepeat","spls2wayrepeat", "lmregrepeat","plsrepeat",
pairedanalysis = TRUE, featselmethod=c("splsrepeat","plsrepeat","lmregrepeat"),
        pvalue.thresh=0.05,
