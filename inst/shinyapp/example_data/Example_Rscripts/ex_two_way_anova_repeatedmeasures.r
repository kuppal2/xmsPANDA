...
source("/Users/karanuppal/Documents/Emory/JonesLab/Projects/DifferentialExpression/xmsPaNDA/xmsPANDA_v1.0.6.43.R")
...
outloc<-"~/Downloads/testpandav1.0.7.5twowayrepeat/"
...
demetabs_res<-diffexp(
        ...
        pairedanalysis = TRUE, featselmethod=c("lm2wayanovarepeat","limma2wayrepeat","spls2wayrepeat"),pvalue.thresh=0.05,
