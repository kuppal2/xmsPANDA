get_plsplots_v1.0.8.64 <-
function(X,plsres,plsvar,samplelabels,filename=NA,ncomp=5,center=TRUE,scale=TRUE,legendcex=0.5,outloc=getwd(),col_vec=NA,sample.col.opt="default",alphacol=0.3,
                       legendlocation="topright",class_levels=NA,pca.cex.val=3,ellipse.conf.level=0.95,main_text="PLS-DA score plots")
{
  ...
  pch_vec<-c(3,5,7,9,12,13,2,17,21) #seq(1,50) #
  ...
  if(result$ncomp>1){
    ...
    # de1<-(dataEllipse(x=result$variates$X[,1], y=result$variates$X[,2],groups=as.factor(samplelabels),grid=FALSE,lwd=0.5,levels=c(ellipse.conf.level),pch=pch,col=col_per_group,center.pch=NULL,xlab=paste("PLS1 (",r1[1],"% variation)",sep=""),ylab=paste("PLS2 (",r1[2],"% variation)",sep=""),group.labels="",main=main_text,fill=TRUE,cex.main=0.7))
    ...
    de1<-(dataEllipse(x=result$variates$X[,1], y=result$variates$X[,2],groups=as.factor(samplelabels),grid=FALSE,lwd=0.5,levels=c(ellipse.conf.level),col=col_per_group,pch=pch_per_group,
                      xlab=paste("PLS1 (",r1[1],"% variation)",sep=""),ylab=paste("PLS2 (",r1[2],"% variation)",sep=""),group.labels="",main=main_text1,fill=TRUE,cex.main=0.7,center.pch=FALSE,
    ...
    w <- 0.1
    par(omd=c(0, 1-w, 0, 1),cex.main=0.7)
    #   de1<-(dataEllipse(x=result$variates$X[,1], y=result$variates$X[,2],groups=as.factor(samplelabels),grid=FALSE,lwd=1,levels=NULL,pch=pch,col=col_per_group,center.pch=NULL,xlab=paste("PLS1 (",r1[1],"% variation)",sep=""),ylab=paste("PLS2 (",r1[2],"% variation)",sep=""),group.labels="",main=main_text,fill=FALSE,add=FALSE,cex.main=0.7))
    ...
    dataEllipse(x=result$variates$X[,1], y=result$variates$X[,2],groups=as.factor(samplelabels),grid=FALSE,lwd=0.5,levels=NULL,col=col_per_group,center.pch=NULL,pch=pch_per_group,xlab=paste("PLS1 (",r1[1],"% variation)",sep=""),ylab=paste("PLS2 (",r1[2],"% variation)",sep=""),group.labels="",main=main_text,fill=TRUE,cex.main=0.7,add=FALSE,ylim=c(min(result$variates$X[,2])-iqr_ylim,max(result$variates$X[,2])+iqr_ylim),xlim=c(min(result$variates$X[,1])-iqr_xlim,max(result$variates$X[,1])+iqr_xlim))
    
    le1<-(legend(par('usr')[2], par('usr')[4], bty='n', xpd=NA,l1, col = col_per_group,pch = pch_per_group, pt.cex = 0.6, title = "Class",cex=0.8))
    
    #  (legend(legendlocation, l1, col = col_per_group,pch = pch_per_group, pt.cex = cex[1], title = "Class", cex=cex[1]))
  ...
  if(result$ncomp>2){
    ...
    main_text1=paste(main_text,"\n with elliptical contours at 95% confidence interval",sep="")
    dataEllipse(x=result$variates$X[,1], y=result$variates$X[,3],groups=as.factor(samplelabels),grid=FALSE,lwd=0.5,levels=c(ellipse.conf.level),col=col_per_group,pch=pch_per_group,xlab=paste("PLS1 (",r1[1],"% variation)",sep=""),ylab=paste("PLS3 (",r1[3],"% variation)",sep=""),group.labels="",main=main_text1,fill=TRUE,cex.main=0.7,center.pch=FALSE,ylim=c(min(result$variates$X[,3])-iqr_ylim,max(result$variates$X[,3])+iqr_ylim),xlim=c(min(result$variates$X[,1])-iqr_xlim,max(result$variates$X[,1])+iqr_xlim))
    ...
    dataEllipse(x=result$variates$X[,1], y=result$variates$X[,3],groups=as.factor(samplelabels),grid=FALSE,lwd=0.5,levels=NULL,col=col_per_group,pch=pch_per_group,xlab=paste("PLS1 (",r1[1],"% variation)",sep=""),ylab=paste("PLS3 (",r1[3],"% variation)",sep=""),group.labels="",main=main_text,fill=FALSE,cex.main=0.7,center.pch=NULL,add=FALSE,ylim=c(min(result$variates$X[,3])-iqr_ylim,max(result$variates$X[,3])+iqr_ylim),xlim=c(min(result$variates$X[,1])-iqr_xlim,max(result$variates$X[,1])+iqr_xlim))
    ...
    w <- 0.1
    par(omd=c(0, 1-w, 0, 1),cex.main=0.7)
    #   de1<-(dataEllipse(x=result$variates$X[,2], y=result$variates$X[,3],groups=as.factor(samplelabels),grid=FALSE,lwd=1,levels=c(ellipse.conf.level),pch=pch,col=col_per_group,center.pch=NULL,xlab=paste("PLS2 (",r1[2],"% variation)",sep=""),ylab=paste("PLS3 (",r1[3],"% variation)",sep=""),group.labels="",main=main_text,fill=TRUE,cex.main=0.7))
    #(legend(legendlocation, l1, col = col_per_group,pch = pch_per_group, pt.cex = cex[1], title = "Class", cex=cex[1]))
    ...
    dataEllipse(x=result$variates$X[,2], y=result$variates$X[,3],groups=as.factor(samplelabels),grid=FALSE,lwd=0.5,levels=c(ellipse.conf.level),col=col_per_group,pch=pch_per_group,xlab=paste("PLS2 (",r1[2],"% variation)",sep=""),ylab=paste("PLS3 (",r1[3],"% variation)",sep=""),group.labels="",main=main_text1,fill=TRUE,cex.main=0.7,center.pch=FALSE,ylim=c(min(result$variates$X[,3])-iqr_ylim,max(result$variates$X[,3])+iqr_ylim),xlim=c(min(result$variates$X[,2])-iqr_xlim,max(result$variates$X[,2])+iqr_xlim))
    ...
    dataEllipse(x=result$variates$X[,2], y=result$variates$X[,3],groups=as.factor(samplelabels),grid=FALSE,lwd=0.5,levels=NULL,col=col_per_group,pch=pch_per_group,xlab=paste("PLS2 (",r1[2],"% variation)",sep=""),ylab=paste("PLS3 (",r1[3],"% variation)",sep=""),group.labels="",main=main_text,fill=FALSE,cex.main=0.7,center.pch=NULL,add=FALSE,ylim=c(min(result$variates$X[,3])-iqr_ylim,max(result$variates$X[,3])+iqr_ylim),xlim=c(min(result$variates$X[,2])-iqr_xlim,max(result$variates$X[,2])+iqr_xlim))
    
    
    
    # de1<-(dataEllipse(x=result$variates$X[,2], y=result$variates$X[,3],groups=as.factor(samplelabels),grid=FALSE,lwd=1,levels=NULL,pch=pch,col=col_per_group,center.pch=NULL,xlab=paste("PLS2 (",r1[2],"% variation)",sep=""),ylab=paste("PLS3 (",r1[3],"% variation)",sep=""),group.labels="",main=main_text,fill=FALSE,cex.main=0.7,add=FALSE))
    #(legend(legendlocation, l1, col = col_per_group,pch = pch_per_group, pt.cex = cex[1], title = "Class", cex=cex[1]))
    le1<-(legend(par('usr')[2], par('usr')[4], bty='n', xpd=NA,l1, col = col_per_group,pch = pch_per_group, pt.cex = 0.6, title = "Class",cex=0.8))
