                                   ...
                                   randset_maxmean<-do.call(data.frame,randset_maxmean)
                                          ...
                                          #Norm.Agg.Statistic=set_statistic1A$Agg.Statistic/set_statistic1A$Size
                                           ...
                                           metabset_res1<-lapply(1:length(sid_list),function(c){
                                                    ...
                                                    pval_zscore=length(which(as.numeric(as.character(cur_sid_rand[,3]))>as.numeric(as.character(cur_sid_orig[3]))))/itrs
                                                    pval_stdmaxmean=length(which(as.numeric(as.character(cur_sid_rand[,7]))>as.numeric(as.character(cur_sid_orig[7]))))/itrs
