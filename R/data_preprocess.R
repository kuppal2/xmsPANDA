...
<<<<<<< HEAD
                          all.missing.thresh=0.5,group.missing.thresh=0.7,normalization.method="none",
                          log2transform=FALSE,medcenter=FALSE,znormtransform=FALSE,quantile_norm=FALSE,lowess_norm=FALSE,rangescaling=FALSE,paretoscaling=FALSE,mstus=FALSE,sva_norm=FALSE,TIC_norm=FALSE,eigenms_norm=FALSE,madscaling=FALSE,vsn_norm=FALSE,
                          ...
                          create.new.folder=TRUE,log2.transform.constant=1){
...
=======
all.missing.thresh=0.5,group.missing.thresh=0.7,normalization.method="log2transform",
log2transform=FALSE,medcenter=FALSE,znormtransform=FALSE,quantile_norm=FALSE,lowess_norm=FALSE,rangescaling=FALSE,paretoscaling=FALSE,mstus=FALSE,sva_norm=FALSE,TIC_norm=FALSE,eigenms_norm=FALSE,madscaling=FALSE,vsn_norm=FALSE,
cubicspline_norm=FALSE,
missing.val=0,samplermindex=NA, rep.max.missing.thresh=0.5,summary.na.replacement="zeros",featselmethod=NA,pairedanalysis=FALSE,input.intensity.scale="raw",
create.new.folder=TRUE,log2.transform.constant=1){
