...
<<<<<<< HEAD
    ...
    get_boxplots(X=good_feats,Y=Y1,parentoutput_dir=outloc,boxplot.col.opt=boxplot.col.opt,
                 sample.col.opt=sample.col.opt,alphacol=0.3,newdevice=FALSE,cex.plots=cex.plots,
...
=======
    ...
    par(mfrow=c(1,1),family="sans",cex=cex.plots)
    get_boxplots(X=good_feats,Y=Y1,parentoutput_dir=outloc,boxplot.col.opt=boxplot.col.opt,sample.col.opt=sample.col.opt,alphacol=0.3,newdevice=FALSE,cex.plots=cex.plots,ylabel=ylabel,add.pvalues=add.pvalues,add.jitter=add.jitter,boxplot.type=boxplot.type,study.design=analysistype)
